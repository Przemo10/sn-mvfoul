...
from interface.src.custom_model.select_feature_extract_net import get_feature_network
from interface.src.custom_model.pooling_attention import  select_pooling_attention
