...
def main(*args):
    ...
    if only_evaluation == 3:
        ...
        writer = SummaryWriter(f"runs/{current_date}_Xin{net_version}{pooling_type}{model_name} {pre_model} {run_label}")
        start_time = time.time()
        leadearboard_summary = trainer(train_loader, val_loader2, test_loader2, model, optimizer, scheduler, criterion,
