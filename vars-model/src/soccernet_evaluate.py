...
def evaluate(ground_truth_file, predictions_file):
    ...
    for actions in labels["Actions"]:
        ...
        if actions in predictions['Actions']:
            if labels['Actions'][actions]['Offence'] == predictions['Actions'][actions]['Offence'] and severity_class == \
                    predictions['Actions'][actions]['Severity']:
    ...
    balanced_accuracy_offence_severity = np.mean(
        distribution_offence_severity_prediction / distribution_offence_severity_groundtruth)
